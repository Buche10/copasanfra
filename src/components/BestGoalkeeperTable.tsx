          ...
          <table className="w-full text-left border-collapse sm:min-w-[700px]">
            <thead>
              <tr className="bg-slate-100/80 border-b border-slate-200 text-xs font-extrabold text-slate-600 uppercase tracking-wider">
                ...
                <th className="py-4 px-2 sm:px-4">Arquero / Equipo</th>
                <th className="py-4 px-3 text-center hidden sm:table-cell">Categoría</th>
                <th className="py-4 px-3 text-center hidden sm:table-cell" title="Partidos Jugados">PJ</th>
                <th className="py-4 px-2 sm:px-3 text-center text-rose-600 font-bold" title="Goles Encajados">Goles</th>
                <th className="py-4 px-3 text-center text-emerald-700 font-bold hidden sm:table-cell" title="Vallas Invictas (Partidos a 0)">Vallas Invictas</th>
                <th className="py-4 px-2 sm:px-4 text-center font-black text-slate-900 bg-slate-200/50">Prom.</th>
              </tr>
            </thead>
              ...
              {activeGoalkeepers.map((gk, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Stats */}
                    <td className="py-4 px-3 text-center font-semibold text-slate-700 hidden sm:table-cell">{gk.matchesPlayed}</td>

                    {/* Goles Encajados */}
                    <td className="py-4 px-2 sm:px-3 text-center font-bold text-rose-600 bg-rose-50/30">
                      {gk.goalsConceded}
                    </td>

                    {/* Clean Sheets */}
                    <td className="py-4 px-3 text-center font-bold text-emerald-700 hidden sm:table-cell">
                    ...
                    <td className="py-4 px-2 sm:px-4 text-center font-black text-base text-blue-600 bg-slate-100/50">
